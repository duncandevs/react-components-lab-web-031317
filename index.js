...
class ButcherShop extends React.Component{
  render(){
    return React.createElement('div',{className:"butcher-shop"},
      ...
      React.createElement('ul',{},
        [
          React.createElement('li',{key:1},'Tenderloin'),
          React.createElement('li',{key:2},'Short ribs'),
          React.createElement('li',{key:3},'Beef shin'),
          React.createElement('li',{key:4},'Ribeye')
        ]
      )
    )
  }
